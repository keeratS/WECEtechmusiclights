...
try: 
    while True:
        ...
        count_cycle(0.05, 0, 255, 0)     #red
        count_cycle(0.05, 100, 255, 0)   #orange
        count_cycle(0.05, 200, 255, 0)   #yellow
        count_cycle(0.05, 255, 0, 0)     #green
        count_cycle(0.05, 0, 0, 255)     #blue
        count_cycle(0.05, 0, 128, 128)   #purple
